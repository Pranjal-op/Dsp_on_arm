...
extern float32_t lpf_70hz_impulse_responce[LPF_70HZ_IMP_RESP_LEN];
extern float32_t hpf_400hz_impulse_responce[HPF_400HZ_IMP_RESP_LEN];
...
int main(){
   ...
   calc_sig_dft((float32_t *)_10Hz_100Hz_500Hz_signal, (float32_t *)REX, (float32_t *)IMX,
